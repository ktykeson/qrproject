...
const MemberRegistrationForm = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const profileImage = dataURLtoBlob(dataUrl);
    formData.append(`profileImage`, profileImage, `image_${index}.png`);
    ...
    const formDataToSend = {
      ...
      companyRegDate: formData.companyRegDate,
      repName: formData.repName,
      repID: formData.repID,
      repRank: formData.repRank,
