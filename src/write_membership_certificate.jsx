...
const PdfFormMembership = () => {
  ...
  const fillForm = async () => {
    try {
      ...
      const profileImageBytes = await fetch(profileURL).then((res) =>
        res.arrayBuffer()
      );

      const burmeseFontUrl = "./ZawgyiOne-v3.1.ttf";
      const burmeseFontBytes = await fetch(burmeseFontUrl).then((res) =>
        res.arrayBuffer()
      );
      ...
      companyNameMM.setText(
        swapCharacters(formData.company_name_mm, checkArray)
      );
  ...
  return (
    <div>
      <div>
        ...
        <input
          type="text"
          name="company_name_mm"
          value={formData.company_name_mm}
      ...
      <div>
        ...
        <textarea
          name="validity_to_from"
          value={formData.validity_to_from}
          onChange={handleInputChange}
        />
      </div>
      <div>
